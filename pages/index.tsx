...
const index: React.FC<indexProps> = () => {
  ...
  React.useEffect(() => {
    ...
    console.log.apply(console, [
      "%c Designed and Developed by Divya Choudhari %c %c🚀 %c\n",
      ...
      <div id="menu-target" data-scroll-container ref={refScroll}>
        <Head>
          ...
          <meta
            ...
            content="#10101A"
          />
          <title>Divya Choudhari 🚀 &mdash; Frontend Devloper</title>
          <meta
            name="description"
          ...
          <meta
            property="og:title"
            content="Divya Choudhari 🚀 &mdash; Frontend Devloper"
          />
        ...
        <main className="container">
          <p className="about-text">
            Hello stranger! 👋, my name is Divya and I am a frontend engineer,
          ...
          <section id="sectionProjects" className="section-projects">
            ...
            <div className="project-card">
              ...
              >
                <img src="webp/Shareme_front.jpg" alt="alexxandria model" />
                <img src="webp/Shareme_back.jpg" alt="alexxandria logo" />
              </div>
          ...
          >
            <div className="section-reviews__top">
              <h1 className="heading-1">
                <span>Mmmm, liked it... </span> <small>😊</small>
              </h1>
        ...
        <footer className="footer">
          ...
          <div className="footer__socials">
            <a
              href="https://dribbble.com/divyaa22"
              target="_blank"
              rel="noopener"
            >
